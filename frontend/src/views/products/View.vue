    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="10">
                    <strong>Modulo Producto | Ver</strong>
                </b-col>
                <b-col md="2">
                ...
                <b-row class="justify-content-center">
                    ...
                    <b-col md="2">
                        <b-form-group label="Categoria" :description="errors.id_category">
                            <b-form-select size="sm" disabled :options="categories" v-model="product.id_category"></b-form-select>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Codigo" :description="errors.code">
                            <b-form-input size="sm" disabled v-model="product.code"></b-form-input>
                        </b-form-group>
                    </b-col>

                    <b-col md="8">
                        <b-form-group label="Nombre" :description="errors.name">
                            <b-form-input size="sm" disabled v-model="product.name"></b-form-input>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Codigo Barras">
                            <b-form-input size="sm" disabled v-model="product.barcode"></b-form-input>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="IGV" :description="errors.igv">
                            <b-form-select size="sm" disabled :options="igv" v-model="product.igv"></b-form-select>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Unidad de Medida" :description="errors.unit_measure">
                            <b-form-select size="sm" disabled :options="unit_measure" v-model="product.unit_measure"></b-form-select>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Precio Compra" :description="errors.purchase_price">
                            <b-form-input  type="number" disabled step="any" class="text-end" size="sm" v-model="product.purchase_price"></b-form-input>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Precio Venta" :description="errors.sale_price">
                            <b-form-input type="number" disabled step="any" class="text-end" size="sm" v-model="product.sale_price"></b-form-input>
                        </b-form-group>
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Estado">
                            <b-form-select size="sm" disabled v-model="product.state" :options="state"></b-form-select>
                        </b-form-group>
                    </b-col>
                </b-row>
