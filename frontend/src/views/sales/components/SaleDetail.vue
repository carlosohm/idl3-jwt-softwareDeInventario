<template>
  <div class="table-responsive">
    <table class="table table-hover table-striped table-bordered align-middle">
      ...
      <tbody>
        <tr v-for="(item, it) in sale_detail" :key="it">
...
export default {
  ...
  methods: {
    UpdateProduct,
    DeleteProduct,
    ...mapActions(["LoadUpdateSaleDetail"]),
    ...mapActions(["LoadDeleteSaleDetail"]),
  },
  setup() {
...
function UpdateProduct(index) {
  this.LoadUpdateSaleDetail(index);
}

function DeleteProduct(index) {
  this.LoadDeleteSaleDetail(index);
}
