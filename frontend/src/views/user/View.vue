                ...
                <b-row class="justify-content-center">
                    ...
                    <b-col md="6">
                        <b-form-group label="Nombres" :description="errors.name">
                            <b-form-input disabled size="sm" v-model="user.name"></b-form-input>
                        </b-form-group> 
                    </b-col>
                </b-row>
                <b-row class="justify-content-center">
                    <b-col md="6">
                        <b-form-group label="Tipo de Usuario" :description="errors.id_user_type">
                            <b-form-select disabled size="sm" :options="user_type" v-model="user.id_user_type"></b-form-select>
                        </b-form-group> 
                    </b-col>
                </b-row>
                <b-row class="justify-content-center">
                    <b-col md="6">
                        <b-form-group label="Email" :description="errors.email">
                            <b-form-input disabled size="sm" type="email" v-model="user.email"></b-form-input>
                        </b-form-group> 
                    </b-col>
                </b-row>
                <b-row class="justify-content-center">
                    <b-col md="3">
                        <b-form-group label="Contraseña" :description="errors.password">
                            <b-form-input disabled size="sm" type="password" v-model="user.password"></b-form-input>
                        </b-form-group> 
                    </b-col>
                    
                    <b-col md="3">
                        <b-form-group label="Usuario" :description="errors.user">
                            <b-form-input disabled size="sm" v-model="user.user"></b-form-input>
                        </b-form-group> 
                    </b-col>
                </b-row>
                <b-row class="justify-content-center">
                    <b-col md="3">
                        <b-form-group label="Telefono">
                            <b-form-input disabled size="sm" v-model="user.phone"></b-form-input>
                        </b-form-group> 
                    </b-col>
                    <b-col md="3">
                        <b-form-group label="Estado">
                            <b-form-select disabled size="sm" v-model="user.state" :options="state"></b-form-select>
                        </b-form-group> 
                    </b-col>
                </b-row>
