...
class ReportUtilityManagementExport implements FromView, WithColumnFormatting, WithStyles, WithBackgroundColor, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('exports.reports.utility-management',[
            'data' => $this->data
        ]);
