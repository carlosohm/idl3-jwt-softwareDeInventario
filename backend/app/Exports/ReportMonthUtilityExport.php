...
class ReportMonthUtilityExport implements FromView, WithColumnFormatting, WithStyles, WithBackgroundColor, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('exports.reports.month-utility',[
            'data' => $this->data
        ]);
